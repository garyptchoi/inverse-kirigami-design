% Main program for designing generalized ancient Islamic quad kirigami patterns
%
% Note: 
% - The option of controlling the contracted boundary shape is not yet available.
% - The ancient Islamic quad unit cell pattern is from:
...
unit_dir =  'unit_cell_scripts/islamicquad/'; 
...
% prevent flipping of the 8-gons
flip_anglesD = [...
    face_setsD{1}(:,3), face_setsD{1}(:,4), face_setsD{1}(:,8); ...
    face_setsD{1}(:,7), face_setsD{1}(:,8), face_setsD{1}(:,4); ...
    face_setsD{1}(:,8), face_setsD{1}(:,3), face_setsD{1}(:,7); ...
    face_setsD{1}(:,4), face_setsD{1}(:,7), face_setsD{1}(:,3)];
...
name = strcat('results/islamicquad_',shape_name, '_w', num2str(width), '_h', num2str(height),...
