...
% works for kagome and ancient Islamic tessellations

function points0 = get_contracted_shape_v2(pointsD, face_sets, intervals, face_adjs, Dto0)
    ...
    points0(Dto0(face1),:) = pointsD(face1,:);
    ...
    for i = 1:size(face_adjs,1)
        ...
        translation_vector = points0(Dto0(fixed_pointD),:) - pointsD(fixed_pointD2,:); 
        points0_face2 = pointsD(face2,:) + repmat(translation_vector,length(face2),1);
