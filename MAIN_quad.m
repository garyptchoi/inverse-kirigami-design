% Main program for designing generalized quad kirigami patterns
%
%
...
% rectangular_ratio = 1.5; % 2 means desired width-to-height ratio = 2:1, can be changed to other values
...
name = strcat('results/quad_',shape_name, '_w', num2str(width), '_h', num2str(height),...
