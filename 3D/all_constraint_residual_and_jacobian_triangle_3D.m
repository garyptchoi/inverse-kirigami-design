...
% for 3D surface fitting triangle (kagome) kirigami patterns
%
% Equality constraints:
% - edge length
% - angle sum
% - surface matching
% - (no need to have planarity constraint as triangles must be planar)
...
function [R_ineq, R, J_ineq, J] = all_constraint_residual_and_jacobian_triangle_3D(...
    points, edges, edge_pairs, angles, rings, boundary_rings, ...
